...
import { getSvg, getEntidades, getMapeamento, salvarMapeamento, getTooltip, uploadDxf, getOverlays, salvarOverlay, deletarOverlay } from './esquematicos.controller';
...
router.get('/:vista/overlays',          authenticate, getOverlays);
router.post('/:vista/overlays',         authenticate, authorize('administrador_empresa', 'administrador_geral'), salvarOverlay);
router.delete('/:vista/overlays/:overlayId', authenticate, authorize('administrador_empresa', 'administrador_geral'), deletarOverlay);
